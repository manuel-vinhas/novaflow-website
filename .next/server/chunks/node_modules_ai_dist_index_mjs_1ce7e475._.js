...
var DefaultStreamTextResult = class {
  ...
  However, the LLM results are expected to be small enough to not cause issues.
    ...
    sendUsage = true, sendReasoning = false, sendSources = false }) {
    ...
    pipeDataStreamToResponse(response, { status, statusText, headers, data, getErrorMessage: getErrorMessage5, sendUsage, sendReasoning, sendSources } = {}) {
        writeToServerResponse({
            response,
            status,
            statusText,
    ...
    toDataStreamResponse({ headers, status, statusText, data, getErrorMessage: getErrorMessage5, sendUsage, sendReasoning, sendSources } = {}) {
