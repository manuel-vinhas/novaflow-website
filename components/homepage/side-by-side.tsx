...
const features = [
  {
    name: 'Build faster',
    description:
      'Get up and running in no time with pre-configured AI automation settings. Say goodbye to tedious setup and focus on what truly matters – growing your business.',
    icon: Computer,
  },
  {
            ...
            <div className="lg:max-w-lg">
              ...
              <div className="mb-6 w-fit rounded-full border border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-900/30 px-4 py-1">
                <div className="flex items-center gap-2 text-sm font-medium text-blue-900 dark:text-blue-200">
                  ...
                  <span>Why Choose NovaFlow</span>
                </div>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900 dark:from-white dark:via-blue-300 dark:to-white pb-2">
                Less friction on your bussiness
              </h2>
              <p className="mt-6 text-lg text-gray-600 dark:text-gray-300">
                Our team specializes in identifying business processes that can be optimized with AI and delivering custom automation solutions that drive efficiency.
              </p>
